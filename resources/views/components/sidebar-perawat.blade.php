...
<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto perawat-nav">
        <li class="nav-item">
            <x-nav-link href="/perawat-dashboard" :active="request()->is('perawat-dashboard')" icn="bi bi-house-door me-2">
                Dashboard
            </x-nav-link>
        </li>
        <li class="nav-item">
            <x-nav-link href="/detail-rekam" :active="request()->is('detail-rekam')"
                icn="bi bi-activity me-2">
                Detail Rekam Medis
            </x-nav-link>
        </li>
    </ul>

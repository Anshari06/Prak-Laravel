...
@section('page-heading', 'Profil Dokter')
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('dokter.profile.edit') }}" class="btn btn-primary btn-sm">Edit
                        Profil</a>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <a href="{{ route('dokter.profile.edit') }}" class="btn btn-warning">Edit
                                Profil</a>

...
@section('page-heading', 'Manage Role')

@section('content')
    <div class="container-fluid p-0">
        <h2 class="mt-0 mb-2">Manage Role</h2>
        <p class="mb-3">Data role / permission.</p>
            ...
            <div class="table-responsive">
                <table class="table table-striped-hover mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center py-4">Tidak ada data role</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
